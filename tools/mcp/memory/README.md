...
ar-memory is defined as a service in `flowtree/core/controller/docker-compose.yml`:

```bash
docker compose -f flowtree/core/controller/docker-compose.yml up -d ar-memory
```
