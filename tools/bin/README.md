...
python3 tools/bin/ar-find-method forward flowtree/runtime/
python3 tools/bin/ar-find-method handleSubmit flowtree/runtime/src/
```
...
python3 tools/bin/ar-class-outline flowtree/runtime/src/main/java/io/flowtree/jobs/ClaudeCodeJob.java
python3 tools/bin/ar-class-outline flowtree/runtime/src/main/java/io/flowtree/jobs/EnforcementRule.java
```
