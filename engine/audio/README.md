...
- [Compose Module](../../studio/compose/README.md) - Protobuf persistence, PrototypeDiscovery
- [Graph Module](../../domain/graph/README.md) - Cell and temporal abstractions
- [Time Module](../../compute/time/README.md) - Temporal processing
- [Collect Module](../../base/collect/README.md) - PackedCollection operations
- [Hardware Module](../../base/hardware/README.md) - GPU acceleration
