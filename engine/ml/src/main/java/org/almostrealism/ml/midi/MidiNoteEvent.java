 ...
 * and instrument information. This is the raw representation before
 * tokenization into {@link MidiCompoundToken}s.
 *
 * <p>Onset and duration are stored in ticks at the resolution defined
 * by {@link MidiTokenizer#TIME_RESOLUTION} (100 ticks per second).</p>
 *
 * @see MidiFileReader
 * @see MidiTokenizer
 */
