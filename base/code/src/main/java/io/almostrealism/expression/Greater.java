...
/**
 * A greater-than ({@code >}) or greater-than-or-equal ({@code >=}) comparison expression.
 *
 * <p>Generates {@code left > right} or {@code left >= right} depending on the
 * {@code orEqual} flag. Constant operands are folded at construction time.</p>
 */
public class Greater extends Comparison {
	...
	/**
	 * Constructs a strict greater-than comparison ({@code left > right}).
	 *
	...
	/**
	 * Constructs a greater-than or greater-than-or-equal comparison.
	 *
	 * @param left    the left operand
	 * @param right   the right operand
	...
	/**
	 * Creates a strict greater-than expression ({@code left > right}), folding constants.
	 *
	 * @param left  the left operand
	 * @param right the right operand
	 * @return a boolean constant if both operands are constant, otherwise a {@link Greater}
	 */
	public static Expression<Boolean> of(Expression<?> left, Expression<?> right) {
		return Greater.of(left, right, false);
	}

	/**
	 * Creates a greater-than or greater-than-or-equal expression, folding constants.
	 *
	 * @param left    the left operand
	 * @param right   the right operand
	 * @param orEqual {@code true} for {@code >=}, {@code false} for {@code >}
