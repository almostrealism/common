...
public class RectangularLight extends Plane implements SurfaceLight {
  /** Width of the rectangular light area in world units. */
  private double width;

  /** Height of the rectangular light area in world units. */
  private double height;

  /** Total intensity emitted by this light. */
  private double intensity;

  /** Number of {@link org.almostrealism.color.PointLight} samples generated by default. */
  private int samples;
