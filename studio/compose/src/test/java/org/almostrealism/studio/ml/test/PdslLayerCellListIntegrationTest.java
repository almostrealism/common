...
public class PdslLayerCellListIntegrationTest extends TestSuiteBase
	...
	public void testStatePersistsAcrossTemporalTick() {
		...
		PackedCollection signal1 = new PackedCollection(BUFFER_SIZE);
		signal1.fill(1.0);
		PackedCollection signal2 = new PackedCollection(BUFFER_SIZE);
		signal2.fill(2.0);
	...
	public void testBlockToTemporalAdapterForwardFlow() {
		...
		PackedCollection input = new PackedCollection(BUFFER_SIZE);
		input.fill(1.0);
