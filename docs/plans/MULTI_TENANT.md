...
**`FlowTreeController`** (`flowtree/core/src/main/java/io/flowtree/slack/FlowTreeController.java`):
...
**`SlackTokens`** (`flowtree/core/src/main/java/io/flowtree/slack/SlackTokens.java`):
...
**`SlackNotifier`** (`flowtree/core/src/main/java/io/flowtree/slack/SlackNotifier.java`):
...
**`SlackListener`** (`flowtree/core/src/main/java/io/flowtree/slack/SlackListener.java`):
...
**`WorkstreamConfig`** (`flowtree/core/src/main/java/io/flowtree/slack/WorkstreamConfig.java`):
...
**`Workstream`** (`flowtree/core/src/main/java/io/flowtree/slack/Workstream.java`):
- Runtime representation of one workstream — has `channelId`, `channelName`, `githubOrg`, etc.
- No workspace identifier

### GitHub Token Flow

**`GitHubProxyHandler`** (`flowtree/core/src/main/java/io/flowtree/slack/GitHubProxyHandler.java`):
...
**Files to modify:**
- `flowtree/core/src/main/java/io/flowtree/slack/WorkstreamConfig.java` — add `SlackWorkspaceEntry`, `slackWorkspaces` list, `slackWorkspaceId` on `WorkstreamEntry`
- `flowtree/core/src/main/java/io/flowtree/slack/Workstream.java` — add `slackWorkspaceId` field
...
**Files to modify:**
- `flowtree/core/src/main/java/io/flowtree/slack/SlackTokens.java` — add `from(SlackWorkspaceEntry)` factory
...
**Files to modify:**
- `flowtree/core/src/main/java/io/flowtree/slack/FlowTreeController.java` — major refactor of fields and startup
...
**Files to modify:**
- `flowtree/core/src/main/java/io/flowtree/slack/SlackListener.java` — channel key, method signatures, per-workspace notifier dispatch
...
**Files to modify:**
- `flowtree/core/src/main/java/io/flowtree/slack/FlowTreeApiEndpoint.java` — notifier resolver
- `flowtree/core/src/main/java/io/flowtree/slack/SlackNotifier.java` — no changes needed for Option A
...
**Files to modify:**
- `flowtree/core/src/main/java/io/flowtree/slack/FlowTreeController.java` — merge all workspace githubOrgs
- `flowtree/core/src/main/java/io/flowtree/slack/GitHubProxyHandler.java` — add `X-Workstream-Id` header handling (Phase 2)
...
- `flowtree/core/src/main/java/io/flowtree/slack/FlowTreeApiEndpoint.java` — embed workspace in job tokens
...
|------|-------------|-------|
| `flowtree/core/src/main/java/io/flowtree/slack/WorkstreamConfig.java` | Add `SlackWorkspaceEntry`, `slackWorkspaces`, `slackWorkspaceId` on entry | 1a |
| `flowtree/core/src/main/java/io/flowtree/slack/Workstream.java` | Add `slackWorkspaceId` field | 1a |
| `flowtree/core/src/main/java/io/flowtree/slack/SlackTokens.java` | Add `from(SlackWorkspaceEntry)` factory | 1a |
| `flowtree/core/src/main/java/io/flowtree/slack/FlowTreeController.java` | Multi-workspace startup, `WorkspaceConnection` inner class | 1b |
| `flowtree/core/src/main/java/io/flowtree/slack/SlackListener.java` | Workspace-aware channel key, `workspaceId` parameters | 1c |
| `flowtree/core/src/main/java/io/flowtree/slack/FlowTreeApiEndpoint.java` | Notifier resolver for per-workspace dispatch | 1c |
| `flowtree/core/src/main/java/io/flowtree/slack/GitHubProxyHandler.java` | Workspace-scoped token resolution (Phase 2) | 1d |
| `flowtree/core/src/main/java/io/flowtree/slack/GitHubTokenValidator.java` | Validate per-workspace githubOrgs sections | 1d |
