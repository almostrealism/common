...
`flowtree/runtime/controller/docker-compose.yml` alongside `ar-memory`:
...
1. **`flowtree/runtime/src/test/java/io/flowtree/jobs/McpToolDiscoveryTest.java`**
...
- `ar-tracker` service entry in `flowtree/runtime/controller/docker-compose.yml`
...
flowtree/runtime/src/test/java/io/flowtree/jobs/
...
- `flowtree/runtime/controller/docker-compose.yml` — live example of adding a new service
