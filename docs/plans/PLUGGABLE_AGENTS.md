...
1. **The job class was renamed.** Plan §2.1 explicitly recommended *keeping*
   ...
   - File: `flowtree/runtime/src/main/java/io/flowtree/jobs/CodingAgentJob.java`
...
- **Phase 3 (opencode runner) is not done.** No
  ...
  (`flowtree/runtime/agent/Dockerfile`) installs only `@anthropic-ai/claude-code`;
...
`flowtree/runtime/rebuild.sh --agents` is sufficient — all changes are inside the
...
`flowtree/runtime/src/main/java/io/flowtree/jobs/ClaudeCodeJob.java` (1,576 lines)
...
(`flowtree/runtime/src/main/java/io/flowtree/jobs/ClaudeAttemptRunner.java`) is
...
`McpConfigBuilder` (`flowtree/runtime/src/main/java/io/flowtree/jobs/McpConfigBuilder.java`)
emits two artifacts:
...
| HTTP endpoint | `flowtree/runtime/src/main/java/io/flowtree/slack/FlowTreeApiEndpoint.java` (`POST /api/workstreams/{id}/submit`) |
| Slack listener | `flowtree/runtime/src/main/java/io/flowtree/slack/SlackListener.java` |
...
```
flowtree/runtime/src/main/java/io/flowtree/ClaudeCodeClient.java
...
flowtree/runtime/src/main/java/io/flowtree/slack/SlackListener.java
flowtree/runtime/src/main/java/io/flowtree/slack/FlowTreeController.java
flowtree/runtime/src/main/java/io/flowtree/slack/FlowTreeApiEndpoint.java
```

Test sites (`flowtree/runtime/src/test/java/io/flowtree/...`) reference the class
...
- `ClaudeCodeJob.Factory` is a backward-compat alias that is itself part of
  the wire-format identity (see `flowtree/runtime/src/main/java/io/flowtree/jobs/ClaudeCodeJob.java:1568`).
...
`flowtree/runtime/src/test/java/io/flowtree/jobs/` must pass unchanged through
...
**Files added:**
- `flowtree/runtime/src/main/java/io/flowtree/jobs/agent/AgentRunner.java`
- `flowtree/runtime/src/main/java/io/flowtree/jobs/agent/AgentRunRequest.java`
- `flowtree/runtime/src/main/java/io/flowtree/jobs/agent/AgentRunResult.java`
- `flowtree/runtime/src/main/java/io/flowtree/jobs/agent/AgentCapabilities.java`
- `flowtree/runtime/src/main/java/io/flowtree/jobs/agent/AgentRunnerRegistry.java`
- `flowtree/runtime/src/main/java/io/flowtree/jobs/agent/ClaudeCodeRunner.java`
- `flowtree/runtime/src/test/java/io/flowtree/jobs/agent/ClaudeCodeRunnerTest.java`
...
- `tools/mcp/manager/test_server.py` — assert parameters declared in
  signature.
- `flowtree/runtime/src/test/java/io/flowtree/jobs/McpToolDiscoveryTest.java` —
...
**Files added:**
- `flowtree/runtime/src/main/java/io/flowtree/jobs/agent/OpencodeRunner.java`
- `flowtree/runtime/src/main/java/io/flowtree/jobs/agent/OpencodeBinaryLocator.java`
- `flowtree/runtime/src/main/java/io/flowtree/jobs/agent/OpencodeOutputParser.java`
- `flowtree/runtime/src/test/java/io/flowtree/jobs/agent/OpencodeRunnerTest.java`
- `flowtree/runtime/src/test/java/io/flowtree/jobs/agent/OpencodeOutputParserTest.java`
- `flowtree/runtime/src/test/java/io/flowtree/jobs/agent/AgentRunnerSmokeIT.java`
  (disabled by default).
...
- `flowtree/runtime/src/main/java/io/flowtree/jobs/ClaudeCodeJob.java`
- `flowtree/runtime/src/main/java/io/flowtree/jobs/ClaudeAttemptRunner.java` → rename
- `flowtree/runtime/src/main/java/io/flowtree/jobs/ClaudeInactivityMonitor.java` → rename

### Modified in Phase 2 (per-phase selection)
- `flowtree/runtime/src/main/java/io/flowtree/jobs/ClaudeCodeJob.java`
- `flowtree/runtime/src/main/java/io/flowtree/jobs/ClaudeCodeJobFactory.java`
- `flowtree/runtime/src/main/java/io/flowtree/slack/Workstream.java`
- `flowtree/runtime/src/main/java/io/flowtree/slack/WorkstreamConfig.java`
- `flowtree/runtime/src/main/java/io/flowtree/slack/FlowTreeApiEndpoint.java`
...
- `flowtree/runtime/src/test/java/io/flowtree/jobs/McpToolDiscoveryTest.java`
- `flowtree/runtime/src/test/java/io/flowtree/jobs/ClaudeCodeJob*Test.java` (where
