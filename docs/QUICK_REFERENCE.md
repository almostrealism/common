...
costs neither Java heap nor device memory. Set `StateDictionary.enableMaterializeWeights = true`
to read every tensor into a freshly allocated `PackedCollection` at load time
