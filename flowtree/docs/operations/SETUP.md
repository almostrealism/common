...
| Per-phase agent runner selection | per-job (`workstream_submit_task`), workstream defaults (`WorkstreamConfig.workstreams[]`), workspace defaults (`WorkstreamConfig.slackWorkspaces[]`), or controller default | [../architecture/PHASES.md](../architecture/PHASES.md), [RECIPES.md](RECIPES.md) |
