...
/**
 * Advances square wave state for the next sample.
 ...
 * @see SquareWaveCell
 */
public class SquareWaveTick extends WaveCellComputation {

	public SquareWaveTick(SquareWaveCellData data, Producer<PackedCollection> envelope) {
