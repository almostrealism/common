...
/**
 * Advances sawtooth wave state for the next sample.
 *
 * @see WaveCellComputation
 * @see SawtoothWaveCell
 */
public class SawtoothWaveTick extends WaveCellComputation {

	public SawtoothWaveTick(SineWaveCellData data, Producer<PackedCollection> envelope) {
