...
/**
 * Advances triangle wave state for the next sample.
 *
 * @see WaveCellComputation
 * @see TriangleWaveCell
 */
public class TriangleWaveTick extends WaveCellComputation {

	public TriangleWaveTick(SineWaveCellData data, Producer<PackedCollection> envelope) {
