...
public abstract class AcceleratedOperation<T extends MemoryData> extends OperationAdapter<T>
	...
	/** Prints timing statistics for accelerated operations with default (non-verbose) output. */
	public static void printTimes() {
		printTimes(false);
	}

	/**
	 * Prints timing statistics for accelerated operations.
	 *
	 * <p>In verbose mode, includes detailed metrics for:</p>
	 * <ul>
	 *   <li>Memory I/O times (native and Metal buffer operations)</li>
	 *   <li>Compilation times (JNI and Metal)</li>
	 *   <li>Argument preparation and dimension mask computation</li>
	 *   <li>Kernel creation and evaluation breakdown</li>
	 * </ul>
	 *
	 * <p>In non-verbose mode, prints only runtime summary (process and accept times).</p>
	 *
	 * @param verbose true to include detailed timing breakdown, false for summary only
	 */
