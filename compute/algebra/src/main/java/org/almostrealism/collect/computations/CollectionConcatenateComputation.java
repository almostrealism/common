...
public class CollectionConcatenateComputation extends TransitiveDeltaExpressionComputation
	...
	/** The axis along which inputs are concatenated (0-indexed). */
	private final int axis;
	/** Shapes of each input collection. */
	private final TraversalPolicy[] inputShapes;
	/** Cumulative start offsets of each input along the concatenation axis. */
