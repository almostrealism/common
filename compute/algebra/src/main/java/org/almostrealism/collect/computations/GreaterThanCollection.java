 ...
 * <ul>
 *   <li>Clipping: return original value if > threshold, else return threshold</li>
...
public class GreaterThanCollection extends CollectionComparisonComputation {
	...
	/**
	 * Constructs a greater-than comparison computation with configurable equality inclusion.
	 *
	 * @param shape The {@link TraversalPolicy} defining the output shape and traversal pattern
	...
	/**
	 * Generates a new greater-than comparison computation with the specified child processes.
	 ...
	 *
	 * <p>The method delegates to the {@code greaterThan} factory method from
