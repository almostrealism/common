...
#include <jni.h>
double M_PI_F = M_PI;
void f_fourierTransform_866_radix2(double *output, double *input, jint outputOffset, jint inputOffset, jint outputSize, jint inputSize, jint outputDim0, jint inputDim0, jint len, jint inverseTransform, jint isFirstSplit, jint global_id) {
double even_24[1024];
double odd_25[1024];
...
f_fourierTransform_866_radix2(evenFft_26, even_24, 0, 0, 1024, 1024, 0, 0, halfN_28, inverseTransform, 0, global_id);
f_fourierTransform_866_radix2(oddFft_27, odd_25, 0, 0, 1024, 1024, 0, 0, halfN_28, inverseTransform, 0, global_id);
...
void f_fourierTransform_866_calculateTransform(double *output, double *input, jint outputOffset, jint inputOffset, jint outputSize, jint inputSize, jint outputDim0, jint inputDim0, jint len, jint inverseTransform, jint isFirstSplit, jint global_id) {
...
f_fourierTransform_866_calculateTransform(radix2FFT_3, radix2_0, 0, 0, 1024, 1024, 0, 0, halfN_6, inverseTransform, 0, global_id);
f_fourierTransform_866_calculateTransform(radix4Part1FFT_4, radix4Part1_1, 0, 0, 512, 512, 0, 0, quarterN_7, inverseTransform, 0, global_id);
f_fourierTransform_866_calculateTransform(radix4Part2FFT_5, radix4Part2_2, 0, 0, 512, 512, 0, 0, quarterN_7, inverseTransform, 0, global_id);
...
f_fourierTransform_866_radix2(output, input, outputOffset, inputOffset, outputSize, inputSize, outputDim0, inputDim0, len, inverseTransform, isFirstSplit, global_id);
}
 else {
for (int i = 0; i < (len * 2);) {
...
JNIEXPORT void JNICALL Java_org_almostrealism_generated_GeneratedOperation55_apply(JNIEnv *env, jobject obj, jlong commandQueue, jlongArray arg, jintArray offset, jintArray size, jintArray dim0, jint count, jint global_index, jlong global_total, jint global_id) {
jlong *argArr = (*env)->GetLongArrayElements(env, arg, 0);
jint *offsetArr = (*env)->GetIntArrayElements(env, offset, 0);
jint *sizeArr = (*env)->GetIntArrayElements(env, size, 0);
jint *dim0Arr = (*env)->GetIntArrayElements(env, dim0, 0);
jint _866_v602Offset = (int) offsetArr[0];
jint _866_v603Offset = (int) offsetArr[1];
jint _866_v602Size = (int) sizeArr[0];
jint _866_v603Size = (int) sizeArr[1];
jint _866_v602Dim0 = (int) dim0Arr[0];
jint _866_v603Dim0 = (int) dim0Arr[1];
double *_866_v602 = ((double *) argArr[0]);
double *_866_v603 = ((double *) argArr[1]);
for (int global_id = global_index ; global_id < global_total; global_id += 20) {
f_fourierTransform_866_calculateTransform(_866_v602, _866_v603, _866_v602Offset + global_id * 2048, _866_v603Offset + 0 + global_id * 2048, _866_v602Size, _866_v603Size, _866_v602Dim0, _866_v603Dim0, 1024, 0, 0, global_id);
