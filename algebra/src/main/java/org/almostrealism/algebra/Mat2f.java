...
public class Mat2f {
	 ...
	 * different vectors.
	 */
	public void xformVec(Pair src, Pair dest) {
		dest.setX(get(0, 0) * src.x() + get(0, 1) * src.y());
		dest.setY(get(1, 0) * src.x() + get(1, 1) * src.y());
	}

	/** Returns this * b. This creates new matrix. */
